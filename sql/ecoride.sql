...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 15 sep. 2025 à 22:53
...
(1, 14, 1, '10 Rue des Lilas, 75019 PARIS', '5 Avenue de Lyon, 13003 MARSEILLE', '2025-09-21 08:30:00', '08:19:00', 30, 4, 2, 'en_cours'),
...
(4, 17, 4, '3 Rue Oberkampf, 75011 PARIS', '45 Boulevard Rabatau, 13008 MARSEILLE', '2025-09-28 08:30:00', '08:42:00', 35, 3, 1, 'en_cours'),
(5, 18, 5, '129 Avenue des Champs-Élysées, 75008 PARIS', '20 Quai du Port, 13002 MARSEILLE', '2025-09-30 08:53:22', '08:22:00', 33, 4, 3, 'en_cours');
...
CREATE TABLE IF NOT EXISTS `utilisateurs` (
  ...
  `role` enum('passager','chauffeur','les_deux','administrateur','modérateur') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'passager',
...
INSERT INTO `utilisateurs` (`id`, `pseudo`, `email`, `mot_de_passe`, `photo`, `credits`, `role`, `date_inscription`, `actif`) VALUES
(15, 'sophie33', 'sophie@example.com', 'motdepassehashé', 'defaut.png', 20, 'chauffeur', '2025-06-30 17:07:57', 1),
(14, 'jean77', 'jean@example.com', 'motdepassehashé', 'defaut.png', 20, 'chauffeur', '2025-06-30 16:16:42', 1),
(16, 'amine69', 'amine@example.com', 'motdepassehashé', 'defaut.png', 20, 'chauffeur', '2025-06-30 17:07:57', 1),
(17, 'lea_paris', 'lea@example.com', 'motdepassehashé', 'defaut.png', 20, 'chauffeur', '2025-06-30 17:11:03', 1),
(18, 'marc_paris', 'marc@example.com', 'motdepassehashé', 'defaut.png', 20, 'chauffeur', '2025-06-30 17:11:03', 1),
(23, 'Niiby', 'iby.nicolas@neptune-concept.com', '$2y$10$Q.wqpx4o8OX9rzYRx46w.ep96JWjDRhNvUN9JiIl8EPRSUUIFNQAS', 'defaut.png', 30, 'passager', '2025-08-25 15:37:25', 1);
...
CREATE TABLE IF NOT EXISTS `vehicules` (
  ...
  `energie` enum('essence','diesel','hybride','électrique','GPL','autre') CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT 'électrique',
